...
export function Header({ showBackLink, backLinkHref = '/projects', backLinkText = 'Projects' }: HeaderProps) {
  ...
  return (
    <header className="h-[var(--header-height)] bg-[var(--card)] border-b border-[var(--border)] flex items-center justify-between px-6">
      ...
      {user && (
        <div className="relative" ref={dropdownRef}>
          ...
          {showDropdown && (
            <div className="absolute right-0 mt-2 w-56 bg-[var(--card)] border border-[var(--border)] rounded-lg shadow-lg py-1 z-50 animate-fadeIn">
